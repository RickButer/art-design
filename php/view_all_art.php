...
<body>
    ...
    <div class="all_art_container debug">
        <div class="name_art_price_box debug">
            <div class="all_art_name_box debug"></div>
            <img src="" class="all_art_artwork debug" />
            <div class="all_art_price_box debug"></div>
        </div>
